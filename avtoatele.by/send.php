...
try {
    ...
    //Recipients
    $mail->setFrom('eugeni.kovalkov@yandex.by', 'Автоателье');
    $mail->addAddress('auto-katyrye@mail.ru');     // Add a recipient

    // Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Новая заявка с сайта';
    $mail->Body    = "Имя пользователя: ${userName}. Почта: ${userEmail} 
